...
from clarify.utils import audio_utils
...
def example_generator(raw_sampler,
  ...
  for raw_sample in raw_sampler:
    ...
    for sample_subtype in raw_sample:
      ...
      audio = augmentation_utils.augment_audio(audio=audio,
      ...
      audio = standardize_audio_array(audio=audio, audio_shape=audio_shape)
