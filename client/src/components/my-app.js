...
import { navigate, updateOffline, updateDrawerState, updateAccountDropdownState } from '../actions/app.js';
...
let MyApp = class MyApp extends connect(store)(LitElement) {
    constructor() {
        ...
        this._accountDropdownOpened = false;
        this._snackbarOpened = false;
        this._offline = false;
        this._user = '';
        this._toolbarLight = true;
        this._loading = true;
        this._progress = 0;
        this._progressLabel = "";
    ...
    _handle_progress_change(progress) {
    ...
    _outsideAccountDropdownClickDetector(e) {
...
__decorate([
    property({ type: Boolean })
], MyApp.prototype, "_accountDropdownOpened", void 0);
__decorate([
    property({ type: Boolean })
...
], MyApp.prototype, "_user", void 0);
__decorate([
    property({ type: Boolean })
], MyApp.prototype, "_toolbarLight", void 0);
__decorate([
    property({ type: Boolean })
], MyApp.prototype, "_loading", void 0);
__decorate([
    property({ type: Number })
], MyApp.prototype, "_progress", void 0);
__decorate([
    property({ type: String })
], MyApp.prototype, "_progressLabel", void 0);
__decorate([
    property({ type: Boolean })
], MyApp.prototype, "_dashboardActive", void 0);
MyApp = __decorate([
