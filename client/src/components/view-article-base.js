...
export class ViewArticleBase extends PageViewElement {
    ...
    renderSiteHeading(preHeading, heading, subHeading, scrollInfo) {
        return html `
    ...
    renderScrollSpyItem(itemTargetID, itemText) {
        return html `
    ...
    render() {
      ...
      ${this.renderHeader("NEUROSCAPE'S", "Project Clarify", "Applying machine learning to the improvement of emotional intelligence training", "Scroll to read more about our goals and strategy.")}
...
], ViewArticleBase.prototype, "activeSection", void 0);
__decorate([
    property({ type: Map })
], ViewArticleBase.prototype, "_scrollThresholds", void 0);
__decorate([
    property({ type: Object })
], ViewArticleBase.prototype, "_debounceJob", void 0);
__decorate([
    property({ type: Number })
], ViewArticleBase.prototype, "_docHeight", void 0);
