...
let DashViewExercises = class DashViewExercises extends connect(store)(PageViewElement) {
    constructor() {
        super(...arguments);
        this._navSection = 'vocational';
    }
    static get styles() {
        return [
            SharedStyles,
...
], DashViewExercises.prototype, "_navSection", void 0);
DashViewExercises = __decorate([
    customElement('dash-view-exercises')
], DashViewExercises);
export { DashViewExercises };
