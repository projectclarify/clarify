...
let ViewArticleMachineLearning = class ViewArticleMachineLearning extends connect(store)(ViewArticleBase) {
    static get styles() {
        return [
            SharedStyles,
            ButtonSharedStyles,
...
ViewArticleMachineLearning = __decorate([
    customElement('view-article-machine-learning')
], ViewArticleMachineLearning);
export { ViewArticleMachineLearning };
