...
let ViewArticleScalingTpuInput = class ViewArticleScalingTpuInput extends connect(store)(ViewArticleBase) {
    static get styles() {
        return [
            SharedStyles,
            ButtonSharedStyles,
...
ViewArticleScalingTpuInput = __decorate([
    customElement('view-article-scaling-tpu-input')
], ViewArticleScalingTpuInput);
export { ViewArticleScalingTpuInput };
