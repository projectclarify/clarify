...
# -*- coding: utf-8 -*-
# Adapted from https://github.com/kubeflow/kubeflow/blob/master/docs/gke/iap_request.py in turn from https://cloud.google.com/iap/docs/authentication-howto#iap-make-request-python 
...
def query_served_model(url, client_id, request_data):
 
  token, signer_email = get_service_account_token(client_id)
