...
class MultiModalImagingExampleSpecOld(ExampleTemplate):
  ...
  def __init__(self,
               ...
               target_shape=(12,),
               *args, **kwargs):
    super(MultiModalImagingExampleSpec, self).__init__(fields={
        "image": ExampleFieldTemplate(
...
class MultiModalImagingMultiProblemDev(multi_problem_v2.MultiProblemV2,
  ...
  def __init__(self, *args, **kwargs):
    ...
    super(MultiModalImagingMultiProblemDev, self).__init__(
        problems=problems,
        schedule=schedule,
        *args, **kwargs)
...
class MultiModalImagingMultiProblem(multi_problem_v2.MultiProblemV2,
  ...
  def __init__(self, *args, **kwargs):
    ...
    super(MultiModalImagingMultiProblem, self).__init__(
        problems=problems,
        schedule=schedule,
        *args, **kwargs)
...
class MultiModalImagingMultiProblemLarge(multi_problem_v2.MultiProblemV2,
  ...
  def __init__(self, *args, **kwargs):
    ...
    super(MultiModalImagingMultiProblemLarge, self).__init__(
        problems=problems,
        schedule=schedule,
        *args, **kwargs)
...
class MultiModalImagingMultiProblemV2(multi_problem_v2.MultiProblemV2,
  ...
  def __init__(self, *args, **kwargs):
    ...
    super(MultiModalImagingMultiProblemV2, self).__init__(
        problems=problems,
        schedule=schedule,
        *args, **kwargs)
