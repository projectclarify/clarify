...
def get_random_index_subinterval(interval_length, subinterval_length, num_samples):
  ...
  if subinterval_length > interval_length:
    raise ValueError("Can't sample interval of length %s % " % subinterval_length,
...
def normalize_example_multimodal(example, task_id, example_norm_spec, dtype=tf.int64):
  """
